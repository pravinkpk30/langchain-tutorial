...
class SimpleSearchTool(BaseTool):
    ...
    def _run(
        ...
        """Use the tool."""
        # Lazy Loading: The Tavily client is only imported when the _run method is actually called,
        # not when the module is first imported. This can speed up the initial module loading time.
        from tavily import TavilyClient # Its imported from tavily-python
